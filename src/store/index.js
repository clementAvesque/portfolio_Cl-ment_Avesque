        ...
        project: [
            {
                ...
                learn: "Avec le projet Genesiii, j’ai découvert pour la première fois le fonctionnement d’un ORM, en utilisant Prisma pour modéliser et relier mes données dans une base PostgreSQL hébergée sur Neon.tech.J’ai appris à créer un backend complet avec Node.js et Express, à gérer des routes, à connecter le serveur à la base et à intégrer des outils comme Nodemailer et Vonage pour l’envoi d’e-mails et de SMS.Ce projet m’a permis de comprendre la logique d’une application complète, du schéma de données jusqu’à la communication avec l’utilisateur.",
                i_like: "Ce que j’ai le plus aimé dans Genesiii, c’est d’avoir réussi à transformer une simple collecte de données en expérience ludique grâce à un mini escape game.J’ai pris plaisir à allier créativité et technique, à concevoir une logique de jeu fluide et à voir tous les éléments (backend, base, messages) fonctionner ensemble.J’ai aussi particulièrement apprécié la simplicité et la rigueur de Prisma, qui m’a donné envie de continuer à explorer le développement backend.",
                card: "/project/cards/genesii.svg"
            },
            {
                id: "000",
            ...
            },
            {
                ...
                card: "/project/cards/canefora.svg"
            },
            {
                id: "003",
                ...
                card: "/project/cards/danielle.svg"
            },
            {
                id: "004",
                name: "QLTUR G",
            ...
            },
            {
                ...
                card: "/project/cards/flying_to_the_sky.svg"
            }
